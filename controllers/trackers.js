...
trackersRouter.get('/', async (request, response) => {
  ...
  response.json(alerts.map(alert => ({
    ...
    productPriceDiff: alert.product.initial_price - alert.product.current_price,
...
trackersRouter.put('/:id', async (request, response) => {
  ...
  response.status(200).json({
    ...
    productPriceDiff: updatedAlert.product.initial_price - updatedAlert.product.current_price,
